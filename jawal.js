 ...
 .fa::before{font-size: 92%;}
  ...
  font-style: normal;
  src: url("/web/20220324104229im_/https://ita7a.com/fonts/OpenSans-Regular.woff2") format("woff2");
  font-weight: 400;
  font-display: swap;
}
@font-face {
  ...
  src: url('/fonts/fontawesome-webfont.eot#iefix&v=4.5.0') format('embedded-opentype'), url('/fonts/fontawesome-webfont.woff2?v=4.5.0') format('woff2'), url('/web/20220324104229im_/https://ita7a.com/fonts/fontawesome-webfont.woff?v=4.5.0') format('woff'), url('/fonts/fontawesome-webfont.ttf?v=4.5.0') format('truetype'), url('/fonts/fontawesome-webfont.svg?v=4.5.0#fontawesomeregular') format('svg');
  font-weight: normal;
  font-style: normal;
}
.fa {
...
.fa-commenting-o::before { content: ""; }
  ...
  .u-msg{line-height: 1.5!important;}
      ...
      .label-primary,.btn-primary{  
        background-color: #5D706E!important;
      }
      .hid {
        display: none;
      }
  ...
  .mic{
    width:53px;height:50px;margin:1px;border-radius:4px;background-image: url(/web/20220324104229im_/https://ita7a.com/imgs/mic.png);background-size: cover;background-repeat: no-repeat;background-position: center;
  }
